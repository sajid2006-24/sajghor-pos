  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-2xl border p-4 flex flex-wrap gap-3 items-center">
        ...
        <div className="text-sm px-3 py-1.5 rounded-full bg-amber-50 border border-amber-200 flex items-center gap-2"><AlertTriangle size={14}/> {t('stock.lowCount')} {low.length}</div>
        <div className="text-sm px-3 py-1.5 rounded-full bg-slate-50 border">{t('stock.totalItems')} {filtered.length}</div>
      </div>
